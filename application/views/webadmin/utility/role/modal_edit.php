<div id="modal-edit-<?php echo $data->id_role ?>" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <form action="<?php echo site_url('utility/role/process/edit/' . $data->id_role); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php view_list_modul(explode(',', $data->hak_akses), $list_data_kategori, $list_data_modul) ?>
                            </div>
                        </div>
                    </div>
                </div>
