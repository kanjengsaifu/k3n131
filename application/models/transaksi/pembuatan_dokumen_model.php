...
class Pembuatan_dokumen_model extends CI_Model {

    var $table_name = 't_pembuatan_dokumen';
    var $view_name = '';
    ...
    public function select($field, $where = array(), $limit = null, $offset = '', $order = array('field' => null, 'sort' => 'ASC')) {
        $field .= ', (select g.nama_guru from m_guru g where g.kode_guru = t_pembuatan_dokumen.kode_guru) as nama_guru';
