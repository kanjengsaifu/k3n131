<div id="modal-edit-<?php echo $data->id_pembuatan_dok ?>" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('transaksi/pembuatan_dokumen/process/edit/' . $data->id_pembuatan_dok); ?>" method="post" data-parsley-validate novalidate>
                <div class="modal-body font-13">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="" class="control-label">Tanggal </label>
                                <input type="text" name="inp_tgl_pembuatan_dok" value="<?php echo $this->format_date->format_date_dmy($data->tgl_pembuatan_dok) ?>" class="form-control input-sm datepicker" placeholder="tanggal..">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm select2" name="inp_tipe_dok" required>
                                    ...
                                    foreach ($list_data_tipe as $tipe) {
                                        echo '<option value="' . $tipe->nama_list . '" ' . set_select('inp_tipe_dok', $tipe->nama_list, $tipe->nama_list == $data->tipe_dok) . '>' . $tipe->nama_list . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" name="inp_keterangan" value="<?php echo $data->keterangan ?>" class="form-control input-sm " placeholder="keterangan..">
                            </div>
                        </div>                        
                    </div>
