    ...
    <form action="<?php echo site_url('master/siswa/process/edit/' . $data->kode_siswa); ?>" method="post" data-parsley-validate novalidate>
        <div class="modal-body font-13">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" value="profil" name="submit" class="btn btn-default waves-effect waves-light"><?php echo $this->array_custom->get_keterangan('button', 'save') ?></button>
            </div>
        </div>
    </form>
</div>